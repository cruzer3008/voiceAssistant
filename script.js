...
preloadImage("https://raw.githubusercontent.com/QwertyWorks/qwertyworks.github.io/master/Interns/js/images/leftback.png");
  if(!mobileRepeatBug) {
	...
	if(transcript.includes("blue"))
		document.getElementById("bulbPhoto").src = "https://raw.githubusercontent.com/QwertyWorks/qwertyworks.github.io/master/Interns/js/images/rightback.png";
	if(transcript.includes("green"))
	   alert("Green");
	if(transcript.includes("yellow"))
		document.getElementById("bulbPhoto").src = "https://raw.githubusercontent.com/QwertyWorks/qwertyworks.github.io/master/Interns/js/images/leftback.png";
